...
namespace ThorClient.Numerics
{
    /// <summary>
    /// This class was fetched from here: <see href="https://github.com/CognitioConsulting/BigDecimal/tree/master/CognitioConsulting.Numerics">Github Link</see>>
    /// </summary>
    [Serializable]
    public class BigDecimal : IComparable, IComparable<BigDecimal>, IEquatable<BigDecimal>, ISerializable
    {
        ...
        public BigDecimal(Org.BouncyCastle.Math.BigInteger value) : this(new BigInteger(value.ToByteArray()))
        {
