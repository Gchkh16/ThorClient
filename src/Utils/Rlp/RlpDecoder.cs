...
namespace ThorClient.Utils.Rlp
{
    public class RlpDecoder
    {
       ...
       */
        ...
        public const int OFFSET_SHORT_STRING = 0x80;
         ...
         * [0xb8, 0xbf].
         */
        public const int OFFSET_LONG_STRING = 0xb7;
         ...
         * [0xc0, 0xf7].
         */
        public const int OFFSET_SHORT_LIST = 0xc0;
         ...
         */
        public const int OFFSET_LONG_LIST = 0xf7;
            ...
            try
            {
                ...
                while (startPos < endPos)
                {
                    ...
                    else if (prefix == OFFSET_SHORT_STRING)
                    {
                        ...
                        // null
                        rlpList.Values.Add(RlpString.Create(new byte[0]));
                        startPos += 1;
                    ...
                    else if (prefix >= OFFSET_SHORT_LIST && prefix <= OFFSET_LONG_LIST)
                    {
                        ...
                        var newLevelList = new RlpList(new List<RlpType>());
